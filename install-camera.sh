...
sudo apt install -y git python3 python3-pip python3-libcamera python3-picamera2 python3-kms++ python3-pyqt5 python3-prctl python-tk python3-pil.imagetk ffmpeg libatlas-base-dev 
sudo pip3 install numpy piCamera2 keyboard opencv-python opencv-python-headless
